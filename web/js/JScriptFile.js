...
function validation() {
    ...
    ajaxObject.open("POST", "signinServlate?name=" + name + "&password=" + pass, true);
    ajaxObject.send();
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState === 4 && ajaxObject.status === 200) {
            res = ajaxObject.responseText;
            //window.alert(res);
            if (res == 1) {
                window.location = "redirect";
            } else {
                document.getElementById("output").innerHTML = "<div style=\"color:red\">" + " <b> الاسم او كلمةالمرور غير صحيحة!</b> " + "</div> ";
                //window.location = "index.jsp";
            }
        }
    };
}
function validatClient() {
    var name = document.getElementById("t1").value;
    var res = "";
    var ajaxObject = new XMLHttpRequest();
    ajaxObject.open("GET", "checkServ?t1=" + name + "&password=" + res, true);
    ajaxObject.send();
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState == 4 && ajaxObject.status == 200) {
            res = ajaxObject.responseText;
            window.alert(res);
            if (res == 1) {
                window.location = "getClientInfo";
            } else {
                document.getElementById("output").innerHTML = "<div style=\"color:red\">" + " <b> الاسم غير موجود!</b> " + "</div> ";
            }
        }
    };
}
function validate() {
    ...
    var res = ""; //
    var ajaxObject = new XMLHttpRequest();
    ajaxObject.open("GET", "signInAsUserServlate?name=" + name + "&password=" + pass, true);
    ajaxObject.send();
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState == 4 && ajaxObject.status == 200) {
            res = ajaxObject.responseText;
            if (res == 1) {
                window.location = "SetSessionPage";
            } else {
                document.getElementById("output").innerHTML = "<div style=\"color:red\">" + " <b> invalid password or name!</b> " + "</div> ";
            }
        }
    };
}
function messages() {
    var res = ""; //
    var ajaxObject = new XMLHttpRequest();
    ajaxObject.open("GET", "getMessageServelate", true);
    ajaxObject.send();
    var message = document.getElementById("message").value;
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState == 4 && ajaxObject.status == 200) {
            res = ajaxObject.responseText;
            document.getElementById("output").innerHTML = "<div style=\"color:blue\">" + " <p><b> " + message + "</b></p> " + "</div> ";
        }
...
function sendMessage() {
    ...
    var res = ""; //
    var ajaxObject = new XMLHttpRequest();
    ajaxObject.open("GET", "sendingMessage?ssn=" + ssn + "&msg=" + msg, true);
    ajaxObject.send();
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState == 4 && ajaxObject.status == 200) {
            res = ajaxObject.responseText;
...
function extendPeriod() {
    ...
    var res = ""; //
    var ajaxObject = new XMLHttpRequest();
    ajaxObject.open("GET", "extendPeriodBorrow?isbn=" + ISBN + "&s=" + start + "&e=" + end, true);
    ajaxObject.send();
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState == 4 && ajaxObject.status == 200) {
            res = ajaxObject.responseText;
...
function borrow() {
    var h = document.getElementsByClassName("IS") [2];
    alert(h);
}
function searchBook() {
    var searchType = document.getElementById("itemSearch").value;
    var searchName = document.getElementById("searchName").value;
    var res = "";
    var ajaxObject = new XMLHttpRequest();
    ajaxObject.open("GET", "showSpecificBookServlate?Search_options=" + searchType + "&sName=" + searchName, true);
    ajaxObject.send();
    ajaxObject.onreadystatechange = function() {
        if (ajaxObject.readyState == 4 && ajaxObject.status == 200) {
            resultSearch = ajaxObject.responseText;
            document.getElementById("output").innerHTML = "<div style=\"color:black\">" + " <p><b> " + resultSearch + "</b></p> " + "</div> ";
        }
    };
}
var request;
function sendInfo()
{
    ...
    var url = "View/getnames.jsp?val=" + v;
...
function myFunction() {
    var medicalAction = document.getElementById("medicalAction").value;
    var date = document.getElementById("date").value;
    var dataID = document.getElementById("dataID").value;


    var newMedicalAction = prompt("Please enter your name", medicalAction ,"please enter the date", date);
    var newDate = prompt("Please enter your name", date);
    var id = prompt("Please enter your name", dataID);
